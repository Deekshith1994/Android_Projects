...
public class Manage_Appliance extends ActionBarActivity {
	...
	String IPADD2="192.168.0.24:80";//10.39.202.120";
	String user;
	int appPosition;
	String appliance;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String conResult = getConnection ("http://"+IPADD+"/manApp.php","getlisting",user,"appliance","","","","");




		StringTokenizer st = new StringTokenizer(conResult, ",");
